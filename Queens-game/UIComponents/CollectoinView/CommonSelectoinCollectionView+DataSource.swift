...
extension CommonSelectoinCollectionView {
  ...
  private func registerCells() {
    self.register(SelectionCollectionViewCell.self, forCellWithReuseIdentifier: SelectionCollectionViewCell.identifier)
  }
}
